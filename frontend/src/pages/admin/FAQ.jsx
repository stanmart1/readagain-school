            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center sm:justify-start px-3 sm:px-4 py-2 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-primary-700 w-full sm:w-auto"
                >
